...
// ✅ Add this line to preload test expenses:
    ...
    static void commandSpecifier(String fullCommand){
...
//          summary --month 01
    ...
    static void delete(int id, ArrayList<Expense> expenses){
        ...
        System.out.println("### Could not find expense to be deleted, element may not exist\n*** Please try again! ***");
